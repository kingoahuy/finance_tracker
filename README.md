...
<details>
<summary><strong>English Version</strong> · Click to expand without leaving this page</summary>
...
建议将截图放在 `docs/images/` 目录下，并在后续补充到 README：

| 场景 | 建议截图路径 |
| --- | --- |
| Streamlit 记账与分析面板 | `docs/images/streamlit-dashboard.png` |
| 飞书机器人确认卡片 | `docs/images/feishu-bot-card.png` |
| 每日财务日报 | `docs/images/daily-report.png` |
| 飞书多维表格同步效果 | `docs/images/feishu-bitable.png` |
